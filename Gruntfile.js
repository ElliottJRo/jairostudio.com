    ...
    configureGrunt = function (grunt) {
        ...
        var cfg = {
            ...
            watch: {
                livereload: {
                    files: [
                        'content/themes/jairostudio/assets/css/**/*',
                        'content/themes/jairostudio/assets/js/*.js',
                        'content/themes/jairostudio/**/*.hbs',
                        'content/themes/jairostudio/scss',
                ...
                sass: {
                  files: [
                    'content/themes/jairostudio/scss/**/*.scss'
                  ],
                  tasks: ['dev-sass'],
                  options: {
                    debounceDelay: 1000,
            ...
            sass: {
              ...
              dev: {
                  dest: 'content/themes/jairostudio/assets/css/index.css',
                  src: ['content/themes/jairostudio/scss/index.scss']
              }
            },
        ...
        grunt.registerTask('dev', 'Dev Mode; watch files and restart server on changes',
           ['bgShell:ember', 'express:dev', 'dev-sass', 'watch']);

        grunt.registerTask('dev-sass', 'Dev Task: Compile all sass files in jairostudio theme',
           ['sass']);
